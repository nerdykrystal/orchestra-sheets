...
An ASAE (Audit. Substantiate. Adjudicate. Edit.) gate is the mandatory audit artifact that backs every commit in Martinez Methods repos. The gate document is a Markdown file at `deprecated/asae-logs/gate-NN-<descriptor>-YYYY-MM-DD.md` containing YAML frontmatter and N consecutive identical-scope pass blocks. The commit-msg hook validates the gate at commit time — a commit without a valid gate is refused.
...
*v02 (2026-08-05): the only change from v01 is the canonical expansion of ASAE, updated to "Audit. Substantiate. Adjudicate. Edit." per Krystal's ruling of 2026-08-05. v01 is preserved at references/deprecated/.*
